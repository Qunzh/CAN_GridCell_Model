...
$R(\theta_i)$ is computed by integrating over input from all other neurons selective to $\theta_j$ modulated by synaptic connection strength. There are two synaptic connection strength: the constant inhibitory  
